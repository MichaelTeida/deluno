...
function NoteItem({
    ...
    return (
        <div>
            <div
                className={`group flex items-center gap-2 px-2 py-1.5 rounded-lg cursor-pointer text-sm transition-colors ${isActive ? "bg-indigo-100/50 text-indigo-700" : "hover:bg-white/30 text-zinc-700"
                    }`}
            ...
            >
                ...
                <div className="hidden group-hover:flex items-center gap-1">
                    <button
                        ...
                        className="w-5 h-5 flex items-center justify-center text-zinc-400 hover:text-indigo-600"
