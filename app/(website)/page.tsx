    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="flex-1 flex items-center justify-center px-4 py-16 pt-28">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-zinc-900 mb-6 tracking-tight">
            Your workspace for productivity
          </h1>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              { title: "Integrations", desc: "Connect with the tools you already use.", icon: "M13.19 8.688a4.5 4.5 0 011.242 7.244l-4.5 4.5a4.5 4.5 0 01-6.364-6.364l1.757-1.757m13.35-.622l1.757-1.757a4.5 4.5 0 00-6.364-6.364l-4.5 4.5a4.5 4.5 0 001.242 7.244" }
            ].map((f, i) => (
      ...
      <section className="px-4 py-16">
        <div className="max-w-2xl mx-auto glass p-8 md:p-12 text-center" data-variant="panel">
          ...
          <p className="text-zinc-600 mb-8">
            Join alpha testing and try Deluno for free.
          </p>
          <Link
            href="/panel"
            className="btn-glass px-8 text-base h-12"
      ...
      <footer className="p-4">
        <div className="max-w-6xl mx-auto glass px-6 py-6 text-center" data-variant="panel">
          <p className="text-sm text-zinc-500">© 2026 Deluno. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
