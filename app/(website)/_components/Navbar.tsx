...
export default function Navbar() {
    ...
    return (
        ...
        >
            <nav
                className="glass max-w-[1200px] mx-auto px-8 rounded-2xl transition-all duration-500 grid grid-cols-[auto_1fr_auto] items-center"
                style={{ height: scrolled ? 54 : 58 }}
            >
                <Link href="/" className="flex items-center gap-2.5 shrink-0 group" aria-label="Deluno Home">
                ...
                <button
                    ...
                    className="md:hidden ml-auto w-10 h-10 flex items-center justify-center text-zinc-700 dark:text-zinc-300 col-span-2"
            ...
            {mobileOpen && (
                <motion.div
                    ...
                    className="md:hidden mt-2 max-w-[1200px] mx-auto glass rounded-2xl p-4 shadow-xl"
                >
