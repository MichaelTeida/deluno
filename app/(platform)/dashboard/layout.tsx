    ...
    return (
        <div className="flex flex-col h-screen w-full text-zinc-800 p-2 md:p-4 gap-2 md:gap-4 overflow-hidden">
            ...
            <div className="flex flex-1 w-full gap-2 md:gap-4 overflow-hidden min-h-0 relative">
                ...
                <aside className={`
                    ${isRailExpanded ? 'w-48' : 'w-14 md:w-16'} 
                    glass flex-col items-center py-3 md:py-4 gap-2 z-40 shrink-0 
                ...
                `} data-variant="panel">
                    ...
                    {/* Bottom Icons */}
                    <div className="flex flex-col gap-2 w-full items-center mt-auto pt-3 md:pt-4 border-t border-white/10">
                        <button
                            onClick={() => setIsRailExpanded(!isRailExpanded)}
                            className="w-9 h-9 md:w-10 md:h-10 glass flex items-center justify-center text-zinc-500 hover:text-zinc-900 transition-colors"
                            data-variant="interactive"
                        ...
                        <button className="w-9 h-9 md:w-10 md:h-10 glass flex items-center justify-center text-zinc-500 hover:text-zinc-900 transition-colors" data-variant="interactive" title="Ustawienia">
                            <svg className="w-4 h-4 md:w-5 md:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
                        ...
                        <Link href="/" className="w-9 h-9 md:w-10 md:h-10 glass flex items-center justify-center text-zinc-500 hover:text-zinc-900 transition-colors" data-variant="interactive" title="Strona główna">
                            <svg className="w-4 h-4 md:w-5 md:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="ml-4 border-l border-zinc-300/30 pl-2 space-y-1">
                                <div className="flex items-center gap-3 px-3 py-1.5 rounded-lg hover:bg-white/20 cursor-pointer text-sm text-zinc-600 font-medium transition-colors">
                                    ...
                                    <span className="truncate">Element 1</span>
                                </div>
                                <div className="flex items-center gap-3 px-3 py-1.5 rounded-lg bg-indigo-50/50 cursor-pointer text-sm text-indigo-700 font-medium">
                                    <svg className="w-4 h-4 opacity-60 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
                                    </svg>
                                    <span className="truncate">Element 2</span>
                                </div>
                            </div>
                            {['Element', 'Element'].map((item, idx) => (
